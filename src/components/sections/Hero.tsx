        ...
        >
          ...
          <MagneticButton>
            <a
              ...
              download
              className="w-full sm:w-auto text-center inline-block font-mono text-[10px] sm:text-xs tracking-widest uppercase border border-paper/50 text-paper px-4 sm:px-8 py-3 sm:py-4 hover:border-paper hover:bg-paper hover:text-ink hover:scale-105 transition-all duration-300 whitespace-nowrap text-center backdrop-blur-sm"
            >
              Download CV
            </a>
          </MagneticButton>
