...
export default function HUD() {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-[9000] text-paper font-mono text-[10px] md:text-xs uppercase tracking-[0.2em] opacity-40">
      ...
      <div className="absolute top-24 left-20 right-20 flex justify-between items-start">
      ...
      {/* Top Left */}
      <div className="absolute top-20 left-12 w-8 h-[1px] bg-paper" />
      <div className="absolute top-20 left-12 w-[1px] h-8 bg-paper" />
      ...
      {/* Bottom Left */}
      <div className="absolute bottom-6 left-12 w-8 h-[1px] bg-paper" />
      <div className="absolute bottom-6 left-12 w-[1px] h-8 bg-paper" />
      
      {/* Bottom Right */}
      <div className="absolute bottom-6 right-12 w-8 h-[1px] bg-paper" />
      <div className="absolute bottom-6 right-12 w-[1px] h-8 bg-paper" />
